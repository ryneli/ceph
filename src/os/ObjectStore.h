...
public:
  ...
  public:
	...
	fadvise_flags(0) { }
      ...
      // as a plain-old-data type, the move operations are classified as
      // 'trivial', which means that the compiler would generate code identical
      // to the copy operations (i.e. with std::memmove). we want the source
